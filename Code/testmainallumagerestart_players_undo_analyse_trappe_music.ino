  ...
  /* JEU PRINCIPAL */
    ...
    if (j==4){ //si on est à la fin de la ligne
      ...
      if (vert==4){
        ...
        sendCommand(CMD_PLAY_WITHFOLDER, 0X0F00701);//play the first song with volume 15 class 
      ...
      if (i==12){
        ...
        sendCommand(CMD_PLAY_WITHFOLDER, 0X0F00702);//play the first song with volume 15 class 
        //********ouverture trappe
        //********musique loose
      }
